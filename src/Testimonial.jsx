    ...
    <section>
      ...
      >
        ...
        <div className="flex flex-col">
          <p className="text-sm font-bold text-[1.2rem]  text-center  bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent
                 before:from-blue-600 before:to-green-600  leading-tight">{currentMessage}</p>
        </div>
      </div>
    </section>
  );
